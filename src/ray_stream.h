...
int  rayL_stream_stop (ray_actor_t* self);
int  rayL_stream_start(ray_actor_t* self);
void rayL_stream_free (ray_actor_t* self);
void rayL_stream_close(ray_actor_t* self);
